...
source:
  arxiv:
    ...
    include_keywords: null # Keep arxiv papers whose title/abstract contains any of these keywords. Example: ["diffusion", "multimodal"]. If rules filter out all papers in one batch, category-only results are used as fallback.
    exclude_keywords: null # Drop arxiv papers whose title/abstract contains any of these keywords. Example: ["survey", "benchmark"]
  biorxiv:
